...
namespace EPAM_Task_2
{
    class Program
    {
        static void Main()
        {
            ...
            Person[] addperson;
            addperson = new Person[2] 
            { 
                new Person { Name = "Oleg", Age = 31, PhoneNumber = new string[] { "0630000020", " ", "0680000021", " ", "0930000022", " " } },
                new Person { Name = "Volodja", Age = 25, PhoneNumber = new string[]{ "0630000023", " ", "0680000024", " " } } 
            };
            person.AddRange(addperson);
